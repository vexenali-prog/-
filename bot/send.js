  ...
  for (const u of j.result) {
    ...
    if (cmd === '/now' || cmd === '/сейчас' || t === '📡 сейчас') {
      ...
      await send('🎯 Слежу за BTC и TON. Пишу сам, когда пора покупать или продавать.\n\n' +
        '⚡ Мгновенно посмотреть состояние: кнопка «🌐 Открыть Момент» — там всегда живые данные.\n' +
        '«📡 Сейчас» — пришлю сводку в чат при ближайшей проверке (GitHub бесплатный, проверки редкие — может занять и час).\n' +
