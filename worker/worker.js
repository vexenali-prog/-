...
async function viewMenu(env) {
  ...
  return {
    text:
      ...
      "Торговля 9 криптоактивами по трендовой модели, проверенной на " +
  ...
  if (arg === "strategy") {
    return {
      text:
        ...
        "Торгую 9 монет: ядро BTC, ETH, SOL, XRP, DOGE, TRX (на 4 годах " +
        "истории +237%) плюс SUI, ARB, XLM — каждая прошла скрининг из 14 " +
